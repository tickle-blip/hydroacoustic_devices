...
namespace UnityEngine.Rendering.HighDefinition
{
    ...
    public partial class HDRenderPipeline : RenderPipeline
    {
        ...
        bool RenderSonarPasses(ScriptableRenderContext context, CommandBuffer cmd)
        {
            var customPass = SonarsRenderingVolume.VolumeInstance;

            if (customPass == null)
                return false;
            

            return customPass.Execute(context, cmd);
        }
